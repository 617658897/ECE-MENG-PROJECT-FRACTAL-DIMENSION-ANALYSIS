...
cbc_path = r"D:\编程学习\ML-React-App-Template\example\iris-data-classifier\ML-React-App-Template\service\cbc.exe"
solver = SolverFactory('cbc', executable=cbc_path)


img = np.array(mpimg.imread(os.path.join(
    "D:\编程学习\ML-React-App-Template\example\iris-data-classifier\ML-React-App-Template\service\output.png")))
